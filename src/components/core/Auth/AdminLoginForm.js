...
const AdminLoginForm = ({ setIsLoggedIn }) => {
    ...
    return (
        <div className="min-h-screen flex flex-col justify-center items-center bg-khaki-100">
            <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-md relative">
                ...
                <form onSubmit={submitHandler} className="flex flex-col gap-y-4">
                    ...
                    <button className="w-full bg-red rounded-lg text-white py-2 mt-4 cursor-pointer">SEND</button>
                </form>
